    ...
    return (
      ...
      */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[100vw] max-w-[800px] h-px flex items-center pointer-events-none z-10">
                ...
                <div className="absolute right-full w-[50vw] h-px bg-white/10" />

                {/* 3. Right Bleed Line (shoots off to the right edge of the monitor) */}
                <div className="absolute left-full w-[50vw] h-px bg-white/10" />
                ...
                <svg
                    ...
                    viewBox="0 0 15 15"
                    fill="none"
                    className="absolute -left-[7.5px] text-white/20"
                >
                ...
                <svg
                    ...
                    viewBox="0 0 15 15"
                    fill="none"
                    className="absolute -right-[7.5px] text-white/20"
                >
                    <path d="M7.5 0V15M0 7.5H15" stroke="currentColor" strokeWidth="1" />
                </svg>
